...
//		System.out.println(Arrays.toString(batchMates));
		...
		System.out.println("Printing Jagged array using basic for each ");
		
		for(String[] eachBatchMates:batchMates) {
//			System.out.println(Arrays.toString(eachBatchMates));
			for(String eachValue: eachBatchMates)
				System.out.println(eachValue);
		}
		
		System.out.println("Printing Jagged array using basic for loop ");
